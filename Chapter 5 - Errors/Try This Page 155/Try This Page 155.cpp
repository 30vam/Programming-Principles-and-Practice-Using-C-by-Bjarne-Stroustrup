// Try This Page 155.cpp : Get this program to run. Check that our input really does produce that output.
//Try to “break” the program(i.e., get it to give wrong results) by giving
